...
class Service extends Model\Element\Service
{
    ...
    public static function getStreamedResponseByUri(string $uri): ?StreamedResponse
    {
        ...
        if ($config) {
            ...
            } catch (ThumbnailGenerationFailedException | UnableToReadFile $e) {
                // keep the nullable contract of this public helper (see 02_Restricting_Public_Asset_Access.md):
                // the distinction between missing, failed and unreadable thumbnails is only
                // relevant for the internal delivery through the public thumbnail route
                return null;
            }
        }

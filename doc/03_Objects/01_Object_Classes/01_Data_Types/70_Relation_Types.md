...
By default, many-to-many relations that allow assets show an upload button in the field toolbar which uploads a new
...
the many-to-many relation and the advanced many-to-many relation.

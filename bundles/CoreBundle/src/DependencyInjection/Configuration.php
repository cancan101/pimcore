                                ...
                                ->arrayNode('marking_store')
                                    ...
                                    ->children()
                                        ...
                                        ->booleanNode('versioning')
                                            ->defaultFalse()
                                            ->info('Only applies to the "state_table" marking store. When true, the workflow place is tracked alongside the element\'s publish lifecycle: discarding a draft reverts the marking back to the last published baseline. Defaults to false to preserve historical behaviour.')
                                        ->end()
                                    ->end()
